...
namespace ImGui
{
	...
	IMGUI_API void          Separator(float width);											// separator, generally horizontal. inside a menu bar or in horizontal layout mode, this becomes a vertical separator.
	...
	IMGUI_API bool          PlusButton(const char* str_id);									// square button with an plus shape
	IMGUI_API bool          MinusButton(const char* str_id);								// square button with an minus shape
